          ...
          <Darkroom>
            <Toolbar>
              ...
              <CropMenu isCropping={crop}>
                ...
                <button disabled={!hasFile} showOnlyWhen='croppingIsOn' onClick={this.onUndo} style={{color: 'red'}} data-tipsy="Cancel" className="tipsy tipsy--sw">
            ...
            <Canvas ref="canvasWrapper" crop={crop} source={source} angle={angle} width="300" height="300">
